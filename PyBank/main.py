...
# Formatting $ sign in to total and 0 decimal points
...
print(f'Greatest Increase in Profits: {greatest_decrease_date} (${greatest_decrease_loss})')

# Output files ("Main Folder", "Subfolder","New text file name")
output_file = path("Python-Challenge","PyBank","Financial_Analysis" )